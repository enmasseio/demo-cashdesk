...
Customer.prototype.grabGroceries = function () {
  ...
  return util.delay(this.timer, duration)
      .then(function () {
        me.log({event: 'collect', groceries: me.groceries, duration: duration});
      })
};
...
Customer.prototype.pay = function (amount) {
  ...
  return util.delay(this.timer, duration)
      .then(function () {
        me.log({event: 'pay', amount: amount, duration: duration});
      })
};
